class Logger(object):
    ...
    #                    basic_repro_num): Mike's code
    def write_metadata(self, population_size, vacc_percentage, virus):
        # COMPLETED:
        ...
        # Virus object will have: Virus name, mortality_rate, basic_repro_num -> how likely can they
        # Infect someone else
    ...
    def log_infection_survival(self, persons):
